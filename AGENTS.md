...
- **Skill directory**: `kebab-case` (e.g., `angular-best-practices`)
- **SKILL.md**: Always uppercase, always this exact filename
- **AGENTS.md**: Always uppercase, always this exact filename
- **Rule files**: `prefix-description.md` (e.g., `cd-onpush.md`)
...
```bash
cd skills
zip -r angular-best-practices.zip angular-best-practices/
```
